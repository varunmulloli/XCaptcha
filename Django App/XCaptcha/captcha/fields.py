...
class CaptchaTextInput(MultiWidget):
    ...
    def format_output(self, rendered_widgets):
        ...
        return self._args.get('output_format') %dict(image=self.image_and_audio, hidden_field=hidden_field, text_field='<br /><br />Type in the mapping of '+characters + ' : '+text_field)
    ...
    def render(self, name, value, attrs=None):
        ...
        store = CaptchaStore.objects.create(challenge=self.challenge,response=response)
        key = store.hashkey
        value = [key, u'']
